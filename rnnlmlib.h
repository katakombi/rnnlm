...
const unsigned int PRIMES[] =
    ...
    656789717, 716048933, 718518067, 725925469, 733332871, 753085943,
    755555077,
...
class CRnnLM {
 ...
 public:
     ...
     CRnnLM()                   //constructor initializes variables
    {
        ...
        vocab_size = 0;
        vocab =
            (struct vocab_word *)calloc(vocab_max_size,
    ...
    void setLMProbFile(char *str) {
        strcpy(lmprob_file, str);
    }
    void setCompressFile(char *str) {
        strcpy(compress_file, str);
    }

    void setFileType(int newt) {
        filetype = newt;
    }

    void setClassSize(int newSize) {
        class_size = newSize;
    }
    ...
    void setGradientCutoff(real newGradient) {
        gradient_cutoff = newGradient;
    }
    void setDynamic(real newD) {
        dynamic = newD;
    }
    void setGen(real newGen) {
        gen = newGen;
    }
    void setIndependent(int newVal) {
        independent = newVal;
    }

    void setLearningRate(real newAlpha) {
        alpha = newAlpha;
    }
    void setRegularization(real newBeta) {
        beta = newBeta;
    }
    ...
    void setDirectSize(long long newsize) {
        direct_size = newsize;
    }
    void setDirectOrder(int newsize) {
        direct_order = newsize;
    }
    void setBPTT(int newval) {
        bptt = newval;
    }
    void setBPTTBlock(int newval) {
        bptt_block = newval;
    }
    ...
    void setDebugMode(int newDebug) {
        debug_mode = newDebug;
    }
    void setAntiKasparek(int newAnti) {
        anti_k = newAnti;
    }
    ...
    void setKMean(int newKMeanIter) {
        kmean_iter = newKMeanIter;
    }
